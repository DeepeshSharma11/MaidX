...
import { Search, CalendarDays, ShieldCheck, Star, Heart, ArrowRight, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 font-sans selection:bg-indigo-500/30 flex flex-col justify-between">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            >
              ...
              Helpers are ready to join your home
            </motion.div>
      ...
      <footer className="bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 text-xs text-zinc-400 text-center sm:text-left">
            <p>&copy; {new Date().getFullYear()} MaidX. All rights reserved.</p>
            <p className="flex items-center justify-center gap-1">Made with <Heart className="w-3 h-3 text-red-500 fill-red-500" /> for comfortable homes.</p>
          </div>
        </div>
      </footer>
    </div>
