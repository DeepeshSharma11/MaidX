    ...
    return (
      <div className="p-4 md:p-8 space-y-6 pb-24 md:pb-8 max-w-2xl mx-auto md:mx-0">
        ...
        <div className="space-y-3">
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div key={i} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 flex items-center justify-between">
              <div className="w-32 h-5 bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-lg" />
              <div className="w-24 h-6 bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-full" />
            </div>
          ))}
        </div>
      </div>
