    ...
    return (
      <div className="p-4 md:p-8 space-y-6">
        <header className="space-y-2">
          <div className="w-48 h-7 bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-xl" />
          <div className="w-64 h-4 bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-lg" />
        </header>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 flex flex-col gap-3">
              <div className="w-10 h-10 rounded-xl bg-zinc-200 dark:bg-zinc-800 animate-pulse" />
              <div className="space-y-2">
                <div className="w-16 h-6 bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-lg" />
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
          <div className="w-36 h-5 bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-lg" />
          {[1, 2, 3].map((i) => (
