...
import { Send, Loader2, MessageSquare, PhoneCall, HelpCircle, Clock, CheckCircle2, XCircle, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-8 space-y-6 pb-24 md:pb-8 max-w-4xl mx-auto md:mx-0">
      <header>
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Need assistance? Submit a ticket below.</p>
      </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-zinc-900 dark:text-white"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none text-zinc-900 dark:text-white"
              />
            </div>
            {error && <p className="text-sm text-red-500 bg-red-50 dark:bg-red-900/20 px-4 py-2 rounded-xl">{error}</p>}
            {success && <p className="text-sm text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 px-4 py-2 rounded-xl flex items-center gap-2"><CheckCircle2 className="w-4 h-4" /> Ticket submitted! We'll respond soon.</p>}
