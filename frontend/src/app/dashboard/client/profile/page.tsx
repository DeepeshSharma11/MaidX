      ...
      {showOnboardAlert && (
        <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-700 dark:text-amber-400 text-xs mt-0.5">Please add your phone number to complete onboarding and access all features of your dashboard.</p>
          </div>
        </div>
      )}
